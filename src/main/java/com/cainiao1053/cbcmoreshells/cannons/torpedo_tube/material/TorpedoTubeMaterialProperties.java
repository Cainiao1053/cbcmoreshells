...
public record TorpedoTubeMaterialProperties(double minimumVelocityPerBarrel, float weight, int maxSafePropellantStress,
	...
	public TorpedoTubeMaterialProperties {
	...
	public static TorpedoTubeMaterialProperties fromJson(ResourceLocation id, JsonObject obj) {
		...
		return new TorpedoTubeMaterialProperties(minimumVelocityPerBarrel, weight, maxSafeBaseCharges, failureMode,
	...
	public static TorpedoTubeMaterialProperties fromBuf(FriendlyByteBuf buf) {
		...
		return new TorpedoTubeMaterialProperties(minimumVelocityPerBarrel, weight, maxSafeBaseCharges, mode, connectsInSurvival,
	...
	public static final class Builder {
		...
		public TorpedoTubeMaterialProperties build() {
			if (this.failureMode == null) {
				throw new IllegalStateException("Missing required property: failureMode");
			}
			return new TorpedoTubeMaterialProperties(this.minimumVelocityPerBarrel, this.weight,
