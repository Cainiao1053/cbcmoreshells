...
public record ProjectileRackMaterialProperties(double minimumVelocityPerBarrel, float weight, int maxSafePropellantStress,
	...
	public ProjectileRackMaterialProperties {
	...
	public static ProjectileRackMaterialProperties fromJson(ResourceLocation id, JsonObject obj) {
		...
		return new ProjectileRackMaterialProperties(minimumVelocityPerBarrel, weight, maxSafeBaseCharges, failureMode,
	...
	public static ProjectileRackMaterialProperties fromBuf(FriendlyByteBuf buf) {
		...
		return new ProjectileRackMaterialProperties(minimumVelocityPerBarrel, weight, maxSafeBaseCharges, mode, connectsInSurvival,
	...
	public static final class Builder {
		...
		public ProjectileRackMaterialProperties build() {
			if (this.failureMode == null) {
				throw new IllegalStateException("Missing required property: failureMode");
			}
			return new ProjectileRackMaterialProperties(this.minimumVelocityPerBarrel, this.weight,
