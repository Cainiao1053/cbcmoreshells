...
public class DualCannonSlidingBreechInstance extends ShaftInstance<DualCannonSlidingBreechBlockEntity> implements DynamicInstance {

	private final DualCannonSlidingBreechBlockEntity breech;
	private OrientedData breechblock;
	private Direction blockRotation;

	public DualCannonSlidingBreechInstance(MaterialManager dispatcher, DualCannonSlidingBreechBlockEntity tile) {
