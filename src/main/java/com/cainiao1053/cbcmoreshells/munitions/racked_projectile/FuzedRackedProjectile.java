...
public abstract class FuzedRackedProjectile extends AbstractRackedProjectile {
	...
	protected FuzedRackedProjectile(EntityType<? extends FuzedRackedProjectile> type, Level level) {
		super(type, level);
	}
