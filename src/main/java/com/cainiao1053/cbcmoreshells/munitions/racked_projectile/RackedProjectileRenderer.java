...
public class RackedProjectileRenderer<T extends AbstractRackedProjectile> extends EntityRenderer<T> {

	public RackedProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
