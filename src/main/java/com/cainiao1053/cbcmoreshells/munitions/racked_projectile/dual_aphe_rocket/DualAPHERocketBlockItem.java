...
public class DualAPHERocketBlockItem extends FuzedRackedProjectileBlockItem {

	public DualAPHERocketBlockItem(Block block, Properties properties) {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
		...
		RackedRocketProjectileProperties properties = CBCMSMunitionPropertiesHandlers.RACKED_ROCKET.getPropertiesOf(DUAL_APHE_ROCKET.get());
