...
public abstract class FuzedDualCannonProjectile extends AbstractDualCannonProjectile {
	...
	protected FuzedDualCannonProjectile(EntityType<? extends FuzedDualCannonProjectile> type, Level level) {
		super(type, level);
	}
	...
	public void tick() {
		super.tick();
		if (this.canDetonate(fz -> fz.onProjectileTick(this.fuze, this)) && additionalDetonateCondition(this.fuze.getItem())) {
