...
public class DualCannonProjectileRenderer<T extends AbstractDualCannonProjectile> extends EntityRenderer<T> {

	public DualCannonProjectileRenderer(EntityRendererProvider.Context context) {
		super(context);
	}
