...
public class BaguetteProjectileBlockItem extends FuzedProjectileBlockItem {

	public BaguetteProjectileBlockItem(Block block, Properties properties) {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
		...
		String key1 = "block."+Cbcmoreshells.MODID+".baguette_shot.tooltip.title";
		...
		String key2 = "block."+Cbcmoreshells.MODID+".baguette_shot.tooltip.desc";
