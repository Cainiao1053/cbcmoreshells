...
public class AntiairHEShellBlockItem extends FuzedProjectileBlockItem {

	public AntiairHEShellBlockItem(Block block, Properties properties) {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
		...
		String key1 = "block."+Cbcmoreshells.MODID+".antiair_he_shell.tooltip.title";
		...
		String key2 = "block."+Cbcmoreshells.MODID+".antiair_he_shell.tooltip.desc";
