...
public class HighspeedTorpedoBlockItem extends FuzedTorpedoProjectileBlockItem {

	public HighspeedTorpedoBlockItem(Block block, Properties properties) {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
		...
		TorpedoProperties properties = CBCMSMunitionPropertiesHandlers.TORPEDO_PROJECTILE.getPropertiesOf(HIGHSPEED_TORPEDO.get());
