...
public class AntiairShrapnelShellBlockItem extends FuzedProjectileBlockItem {

	public AntiairShrapnelShellBlockItem(Block block, Properties properties) {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
		...
		String key1 = "block."+Cbcmoreshells.MODID+".antiair_shrapnel_shell.tooltip.title";
		...
		String key2 = "block."+Cbcmoreshells.MODID+".antiair_shrapnel_shell.tooltip.desc";
